...
def weather_mesh(lat_list, lon_list):
    ...
    for i in range(num_points):
        ...
        call = (
            ...
            + "&lon="
            + str(lon_list[i])
            + "&appid=e64e8059142aa7d4aa3126405fb4b4d2&units=metric"
        )
        ...
        feature_geojson = {
            ...
            "properties": {"Temp": data["main"]["temp"], "Wind": data["wind"]["speed"]},
        }

        feature_list.append(feature_geojson)

    geojson = {"type": "FeatureCollection", "features": [i for i in feature_list]}
