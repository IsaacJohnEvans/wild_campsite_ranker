...
def wind_shelter_all_data(lat, lng, zoom):
    ...
    shelter, shelter_array = wind_shelter.shelter_index(
        elevation_mat, mask, radius, cellsize, array_return=True
    )
...
data = elevation_mat[
    coord_mask - radius : coord_mask + radius, coord_mask - radius : coord_mask + radius
]
